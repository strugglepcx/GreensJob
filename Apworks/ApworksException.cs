...
namespace Apworks
{
    ...
    public class ApworksException : Exception
    {
        ...
        public ApworksException(string message, Exception innerException) : base(message, innerException) { }
        /// <summary>
        /// Initializes a new instance of the <c>ApworksException</c> class with the specified
        ...
        public ApworksException(string format, params object[] args) : base(string.Format(format, args)) { }
        #endregion
    }
}

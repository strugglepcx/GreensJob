...
namespace Apworks.Queries.Storage
{
    /// <summary>
    /// Represents that the implemented classes are query object storages.
    /// </summary>
    [Obsolete(@"This interface is obsolete, query facilities will be provided in other products, 
or users should use their own mechanism to handle query object storages.")]
    public interface IQueryObjectStorage : IStorage
    {
